...
- **Documents are gated too.** `python .claude/tools/check-docs.py` checks encoding, budgets, cross-references, Tier 1 completeness, the decision index and `.claude/settings.json`, and is part of the one gate command.
